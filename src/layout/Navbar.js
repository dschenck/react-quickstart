         ...
         <nav class="w-full bg-white border-b border-gray-400 px-4">
            <div class="w-full container mx-auto flex flex-wrap items-center justify-between py-2">
               ...
               <div class="block lg:hidden">
                  <button
                     class="flex items-center px-3 py-2 border border-gray-500 rounded text-gray-500 hover:text-black appearance-none focus:outline-none"
                     onClick={() => this.toggle()}
                  >
               ...
               <div
                  class={`w-full flex-grow lg:content-center lg:items-center lg:w-auto ${
                        ...
                        <li class="py-2 lg:py-0">
                           <Dropdown.Dropdown>
                              <button class="text-gray-600 no-underline hover:text-black hover:underline py-2 pl-4 focus:outline-none">
                                 ...
                                 <icons.FaCaretDown class="ml-1 text-sm" />
                              </button>
