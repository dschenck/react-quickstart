      ...
      const ResizeButton = (props) => {
         return (
            <button
               ...
               } px-1 border border-gray-100 w-8 h-6 text-center hover:border-gray-200 focus:outline-none`}
            ...
            <Card.Card>
               ...
               <Card.Body>
                  ...
                  <div class="text-sm w-full mb-2 mt-2">
                     {[2, 3, 4, 6, 9, 12].map((c, i) => (
                        <ResizeButton
                           key={i}
                           columns={c}
                           selected={this.props.layout.columns == c}
                        />
                     ))}
                  </div>
               </Card.Body>
...
class View extends React.Component {
   ...
   render() {
      ...
      return (
         <React.Fragment>
            <h1 class="text-2xl text-gray-600 pb-2">
               Drag, drop and resize dashboard
            </h1>
            <div class="mx-auto flex flex-wrap dragula-container">{cards}</div>
         </React.Fragment>
      );
   }
}
